        ...
        <div class="space-y-5">
            ...
            <div class="p-5 border border-gray-200 rounded hover:border-gray-300 hover:bg-gray-50 transition-colors">
                <div class="flex items-start justify-between mb-2">
                    <div>
                        <h3 class="font-bold text-gray-900">Full Stack Developer</h3>
                        <p class="text-sm text-gray-500">MKT Marketing Digital</p>
                    </div>
            ...
            <div class="p-5 border border-gray-200 rounded hover:border-gray-300 hover:bg-gray-50 transition-colors">
                <div class="flex items-start justify-between mb-2">
                    <div>
                        <h3 class="font-bold text-gray-900">Desarrollador Freelance</h3>
                        <p class="text-sm text-gray-500">Autónomo</p>
                    </div>
